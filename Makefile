...
pkgdatadir = $(datadir)/valinorpaycoin
pkgincludedir = $(includedir)/valinorpaycoin
pkglibdir = $(libdir)/valinorpaycoin
pkglibexecdir = $(libexecdir)/valinorpaycoin
...
CONFIG_HEADER = $(top_builddir)/src/config/valinorpaycoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/valinorpaycoin-config.h.in \
...
ACLOCAL = ${SHELL} /mnt/c/git/ValinorPayCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /mnt/c/git/ValinorPayCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /mnt/c/git/ValinorPayCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /mnt/c/git/ValinorPayCoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /mnt/c/git/ValinorPayCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = valinorpaycoin
PACKAGE_BUGREPORT = www.valinorpaycoin.org
PACKAGE_NAME = Valinorpaycoin Core
PACKAGE_STRING = Valinorpaycoin Core 1.0.0
PACKAGE_TARNAME = valinorpaycoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /mnt/c/git/ValinorPayCoin
abs_srcdir = /mnt/c/git/ValinorPayCoin
abs_top_builddir = /mnt/c/git/ValinorPayCoin
abs_top_srcdir = /mnt/c/git/ValinorPayCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /mnt/c/git/ValinorPayCoin/build-aux/install-sh
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/valinorpaycoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/valinorpaycoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/valinorpaycoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = ValinorPayCoin-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_valinorpaycoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_valinorpaycoin_coverage.info test_valinorpaycoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/ValinorPayCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/valinorpaycoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/valinorpaycoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/valinorpaycoin-config.h
$(top_srcdir)/src/config/valinorpaycoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/valinorpaycoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/ValinorPayCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ValinorPayCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ValinorPayCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_valinorpaycoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_valinorpaycoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_valinorpaycoin_filtered.info: test_valinorpaycoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_valinorpaycoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_valinorpaycoin_coverage.info: baseline_filtered_combined.info test_valinorpaycoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_valinorpaycoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_valinorpaycoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_valinorpaycoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_valinorpaycoin.coverage/.dirstamp:  test_valinorpaycoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_valinorpaycoin.coverage/.dirstamp total.coverage/.dirstamp

# ValinorPayCoin: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_valinorpaycoin.coverage/ total.coverage/ $(OSX_APP)
