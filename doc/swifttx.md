...
This mechanism has been integrated into Bitcore-Node-ValinorPayCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ValinorPayCoin-Project/insight-api-valinorpaycoin#web-socket-api](https://github.com/ValinorPayCoin-Project/insight-api-valinorpaycoin#web-socket-api) 
* API: [https://github.com/ValinorPayCoin-Project/insight-api-valinorpaycoin#swifttx-transactions](https://github.com/ValinorPayCoin-Project/insight-api-valinorpaycoin#swifttx-transactions) 
...
By default, the ValinorPayCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ValinorPayCoin Core daemon:
