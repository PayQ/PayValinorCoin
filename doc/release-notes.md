ValinorPayCoin Core version 2.3.1 is now available from:

  <https://github.com/valinorpaycoin-project/valinorpaycoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/valinorpaycoin-project/valinorpaycoin/issues>

Compatibility
==============

ValinorPayCoin Core is extensively tested on multiple operating systems using
...
ValinorPayCoin Core should also work on most other Unix-like systems but is not
...
This command now handles all cases for starting a masternode instead of having multiple commands based on the context. Command arguments have changed svalinorly to allow the user to decide wither or not to re-lock the wallet after the command is run. Below is the help documentation:
...
Examples:
> valinorpaycoin-cli masternodestart "alias" "my_mn"
...
Examples:
> valinorpaycoin-cli mnvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
...
Examples:
> valinorpaycoin-cli getbudgetprojection
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/valinorpaycoin-project-translations/).
