...
In order to support loading of multiple wallets in valinorpaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is valinorpaycoin.cpp.
...
Changes to valinorpaycoin.cpp
----------------------
valinorpaycoin.cpp is the entry point into valinorpaycoin-qt, and as such, will require some minor modifications to provide hooks for
