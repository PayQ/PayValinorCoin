...
/** Utility functions used by the ValinorPayCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ValinorPayCoin addresses in monospace font
...
// Parse "valinorpaycoin:" URI into recipient object, return true on successful parsing
