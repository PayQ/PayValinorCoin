...
/* Check free space asynchronously to prevent hanging the UI thread.
   ...
   Up to one request to check a path is in fvalinor to this thread; when the check()
...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ValinorPayCoin Core"),
     ...
     * override -datadir in the valinorpaycoin.conf file in the default data directory
     * (to be consistent with valinorpaycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
