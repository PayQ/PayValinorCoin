                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ValinorPayCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ValinorPayCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and valinorpaycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ValinorPayCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ValinorPayCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ValinorPayCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ValinorPayCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ValinorPayCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ValinorPayCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ValinorPayCoin Core help message to get a list with possible ValinorPayCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ValinorPayCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ValinorPayCoin network", "", count));
}
...
{
    QString strTitle = tr("ValinorPayCoin Core"); // default title
    ...
    // Append title to "ValinorPayCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
