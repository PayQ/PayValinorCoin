...
Value getpeerinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Valinorpaycoin Core:x.x.x.x/\",  (string) The string version\n"
    ...
    BOOST_FOREACH (const CNodeStats& stats, vstats) {
        ...
        if (fStateStats) {
            ...
            Array heights;
            BOOST_FOREACH (int height, statestats.vHeightInFvalinor) {
                heights.push_back(height);
            }
            obj.push_back(Pair("infvalinor", heights));
        }
...
Value getaddednodeinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:39797\",  (string) The valinorpaycoin server host and port\n"
...
Value getnetworkinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Valinorpaycoin Core:x.x.x.x/\",     (string) the server subversion string\n"
            ...
            "  ,...\n"
            "  ],\n"
            "  \"relayfee\": x.xxxxxxxx,                (numeric) minimum relay fee for non-free transactions in valinorpaycoin/kb\n"
