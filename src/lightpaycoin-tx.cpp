...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Valinorpaycoin Core valinorpaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  valinorpaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded valinorpaycoin transaction") + "\n" +
                               "  valinorpaycoin-tx [options] -create [commands]   " + _("Create hex-encoded valinorpaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded valinorpaycoin transaction
