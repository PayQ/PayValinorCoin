...
/** 
    ...
    ****Note - for ValinorPayCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of valinorpaycoin coming in to a transaction
     * Note that valinorweight clients may not know anything besides the hash of previous transactions,
