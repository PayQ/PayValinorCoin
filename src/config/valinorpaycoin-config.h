/* src/config/valinorpaycoin-config.h.  Generated from valinorpaycoin-config.h.in by configure.  */
/* src/config/valinorpaycoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.valinorpaycoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Valinorpaycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Valinorpaycoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "valinorpaycoin"
